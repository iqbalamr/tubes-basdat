    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_petugas', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='library.petugas')),
                ('isbn', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='library.buku')),
            ],
        ),
        migrations.CreateModel(
            name='Mengurusi',
            fields=[
                ...
                ('id_peminjam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='library.peminjam')),
                ('id_petugas', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='library.petugas')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='buku',
            name='no_lokasi',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='library.lokasi'),
        ),
    ]
